...
export const ProductForm: React.FC<ProductFormProps> = ({
    ...
    const description = initialData ? "Изменить продукт" : "Добавить новый продукт";
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={loading} placeholder="Название продукта" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type='number' disabled={loading} placeholder="9999" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
